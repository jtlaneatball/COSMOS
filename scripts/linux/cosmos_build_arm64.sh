...
docker pull --platform linux/arm64 alpine:${ALPINE_VERSION}.${ALPINE_BUILD}
...
docker pull --platform linux/arm64 minio/minio:RELEASE.2021-06-17T00-10-46Z
...
docker pull --platform linux/arm64 minio/mc:RELEASE.2021-12-10T00-14-28Z
...
docker pull --platform linux/arm64 traefik:2.7.0
